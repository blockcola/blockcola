...
import "../tokenization/WToken.sol";
...
contract LendingPool is ReentrancyGuard, VersionedInitializable {
    ...
    * @param _receiveWToken true if the liquidator wants to receive wTokens, false otherwise
    * @param _timestamp the timestamp of the action
    **/
    ...
    * @param _reserve the address of the reserve
    **/
    modifier onlyOverlyingWToken(address _reserve) {
        require(
            msg.sender == core.getReserveWTokenAddress(_reserve),
            "The caller of this function can only be the wToken contract of this reserve"
        );
        _;
    }
    ...
    **/
    ...
    /**
    * @dev deposits The underlying asset into the reserve. A corresponding amount of the overlying asset (wTokens)
    * is minted.
    * @param _reserve the address of the reserve
    * @param _amount the amount to be deposited
    ...
    **/
    ...
    {
        WToken wToken = WToken(core.getReserveWTokenAddress(_reserve));

        bool isFirstDeposit = wToken.balanceOf(msg.sender) == 0;

        core.updateStateOnDeposit(_reserve, msg.sender, _amount, isFirstDeposit);

        //minting WToken to user 1:1 with the specific exchange rate
        wToken.mintOnDeposit(msg.sender, _amount);
    ...
    * This function is executed by the overlying wToken contract in response to a redeem action.
    * @param _reserve the address of the reserve
    ...
    **/
    function redeemUnderlying(
        ...
        uint256 _amount,
        uint256 _wTokenBalanceAfterRedeem
    )
        external
        nonReentrant
        onlyOverlyingWToken(_reserve)
        onlyActiveReserve(_reserve)
        onlyAmountGreaterThanZero(_amount)
    {
        ...
        core.updateStateOnRedeem(_reserve, _user, _amount, _wTokenBalanceAfterRedeem == 0);
    ...
    */
    ...
    struct BorrowLocalVars {
        ...
        uint256 borrowFee;
        uint256 requestedBorrowAmountTRX;
        uint256 amountOfCollateralNeededTRX;
        uint256 userCollateralBalanceTRX;
        uint256 userBorrowBalanceTRX;
        uint256 userTotalFeesTRX;
    ...
    **/
        ...
        onlyAmountGreaterThanZero(_amount)
    {
        ...
        (
            ,
            vars.userCollateralBalanceTRX,
            vars.userBorrowBalanceTRX,
            vars.userTotalFeesTRX,
            vars.currentLtv,
        ...
        require(vars.userCollateralBalanceTRX > 0, "The collateral balance is 0");
        ...
        vars.amountOfCollateralNeededTRX = dataProvider.calculateCollateralNeededInTRX(
            _reserve,
            _amount,
            vars.borrowFee,
            vars.userBorrowBalanceTRX,
        ...
        require(
            vars.amountOfCollateralNeededTRX <= vars.userCollateralBalanceTRX,
    ...
    **/
        ...
        onlyAmountGreaterThanZero(_amount)
    {
        ...
        vars.isTRX = TrxAddressLib.trxAddress() == _reserve;
        ...
        require(
            !vars.isTRX || msg.value >= vars.paybackAmount,
        ...
        if (vars.paybackAmount <= vars.originationFee) {
            ...
            core.transferToFeeCollectionAddress.value(vars.isTRX ? vars.paybackAmount : 0)(
                _reserve,
                _onBehalfOf,
                vars.paybackAmount,
        ...
        if(vars.originationFee > 0) {
            core.transferToFeeCollectionAddress.value(vars.isTRX ? vars.originationFee : 0)(
                _reserve,
                _onBehalfOf,
                vars.originationFee,
                addressesProvider.getTokenDistributor()
        ...
        //sending the total msg.value if the transfer is TRX.
        //the transferToReserve() function will take care of sending the
        //excess TRX back to the caller
        core.transferToReserve.value(vars.isTRX ? msg.value.sub(vars.originationFee) : 0)(
            _reserve,
            msg.sender,
            vars.paybackAmountMinusFees
        );
    ...
    * @param _receiveWToken true if the liquidators wants to receive the wTokens, false if
