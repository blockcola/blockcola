...
/**
 * @title DeBit TRC20 WToken
 *
 * @dev Implementation of the interest bearing token for the DLP protocol.
 * @author DeBit
 */
contract WToken is TRC20, TRC20Detailed {
    ...
    **/
    ...
    ) public TRC20Detailed(_name, _symbol, _underlyingAssetDecimals) {
    ...
    /**
     * @notice TRC20 implementation internal function backing transfer() and transferFrom()
     * @dev validates the transfer before allowing it. NOTE: This is not standard TRC20 behavior
     **/
    ...
    **/
    ...
    /**
    * @dev redeems wToken for the underlying asset
    ...
    **/
     ...
     * only lending pools can call this function
     * @param _account the address from which burn the wTokens
    ...
    /**
     * @dev transfers tokens in the event of a borrow being liquidated, in case the liquidators reclaims the wToken
     *      only lending pools can call this function
     * @param _from the address from which transfer the wTokens
    ...
    **/
    ...
    /**
    * @dev calculates the total supply of the specific wToken
    ...
    **/
    ...
    /**
    * @dev executes the transfer of wTokens, invoked by both _transfer() and
