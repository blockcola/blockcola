...
library CoreLibrary {
    ...
    struct ReserveData {
        ...
        **/
        ...
        uint256 decimals;
        /**
        * @dev address of the wToken representing the asset
        **/
    ...
    * @param _self the reserve object
    * @param _wTokenAddress the address of the overlying atoken contract
    ...
    **/
    function init(
        ...
        require(_self.wTokenAddress == address(0), "Reserve has already been initialized");
        ...
        _self.wTokenAddress = _wTokenAddress;
    ...
    function getCompoundedBorrowBalance(
        ...
        if (compoundedBalance == _self.principalBorrowBalance) {
            ...
            if (_self.lastUpdateTimestamp != block.timestamp) {
                ...
                return _self.principalBorrowBalance;
            }
        }
